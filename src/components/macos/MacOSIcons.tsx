...
/**
 * The Gallery - Sleek Minimalist Aperture / Photo Frame Logo
 */
export function GalleryLogo({ className = "h-4 w-4" }: { className?: string }) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
export const AppleLogo = GalleryLogo;

export function FinderAppIcon({ className = "h-11 w-11" }: { className?: string }) {
  return (
    <div
      className={`relative flex items-center justify-center rounded-2xl border border-slate-200 bg-white shadow-md hover:shadow-lg transition ${className}`}
    >
      <svg
        viewBox="0 0 24 24"
        fill="none"
